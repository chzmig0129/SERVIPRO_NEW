...
$routes->get('blueprints/estadoTrampas/(:num)', 'Blueprints::estadoTrampas/$1');
$routes->post('blueprints/guardarEstadosTrampas/(:num)', 'Blueprints::guardarEstadosTrampas/$1');
...
$routes->post('blueprints/guardar_incidencias_batch', 'Blueprints::guardar_incidencias_batch');
