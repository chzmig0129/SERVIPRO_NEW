...
<?php
/**
 * Helper function to normalize plague names (replace underscores with spaces and capitalize)
 */
function normalizarNombrePlaga($nombre) {
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <?php foreach ($listaPlagas as $plaga): ?>
                        ...
                        <button class="filtro-plaga px-3 py-1 rounded-full bg-<?= getColorClass($tipoClase) ?>-100 hover:bg-<?= getColorClass($tipoClase) ?>-200" data-tipo="<?= esc($tipoClase) ?>"><?= esc(normalizarNombrePlaga($plaga['plaga'])) ?></button>
                    <?php endforeach; ?>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <span><?= esc(normalizarNombrePlaga($plaga['plaga'])) ?></span>
                    </div>
                    <?php 
                        endforeach; 
                    else: 
...
document.addEventListener('DOMContentLoaded', function() {
    // Función para normalizar nombres de plagas (reemplazar guiones bajos por espacios)
    function normalizarNombrePlaga(nombre) {
    ...
    function mostrarIncidencias() {
        ...
        incidencias.forEach(incidencia => {
            ...
            marker.addEventListener('mouseenter', function(e) {
                ...
                tooltip.innerHTML = `
                    <div class="font-semibold text-lg mb-1">${normalizarNombrePlaga(this.dataset.tipoPlaga)} - ${this.dataset.tipoIncidencia}</div>
    ...
    function generarResumenIncidencias() {
        ...
        resumenOrdenado.forEach(item => {
            ...
            tr.innerHTML = `
                <td class="px-4 py-2 border">${normalizarNombrePlaga(item.tipoPlaga)}</td>
