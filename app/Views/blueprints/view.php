...
<div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 plano-card">
                ...
                <div class="plano-content">
                    ...
                    <div class="mt-4 plano-actions flex gap-2">
                        <a href="<?= base_url('blueprints/viewplano/' . $plano['id']) ?>" 
                           class="flex-1 text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200">
                            Ver Plano
                        </a>
    ...
    <!-- Modal Confirmar Deshabilitar Sede -->
...
document.getElementById('modalConfirmarDeshabilitarPlano').addEventListener('click', function(e) {
    if (e.target === this) {
