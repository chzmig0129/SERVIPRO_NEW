    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="charts-section">
                ...
                <?php if (!empty($chart_images['pieVoladores'])): ?>
                <div class="chart-container chart-break">
                    <h3 class="chart-title">DISTRIBUCION DE PLAGAS - VOLADORES</h3>
                    <img src="<?= $chart_images['pieVoladores'] ?>" alt="Distribucion Plagas Voladores" class="chart-image">
                    <?php if (!empty($notas_graficas['pieVoladores'])): ?>
                    <div class="chart-notes">
                        <p><strong>OBSERVACIONES:</strong></p>
                        <p><?= nl2br(esc($notas_graficas['pieVoladores'])) ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                
                <?php if (!empty($chart_images['pieRastreros'])): ?>
                <div class="chart-container chart-break">
                    <h3 class="chart-title">DISTRIBUCION DE PLAGAS - RASTREROS</h3>
                    <img src="<?= $chart_images['pieRastreros'] ?>" alt="Distribucion Plagas Rastreros" class="chart-image">
                    <?php if (!empty($notas_graficas['pieRastreros'])): ?>
                    <div class="chart-notes">
                        <p><strong>OBSERVACIONES:</strong></p>
                        <p><?= nl2br(esc($notas_graficas['pieRastreros'])) ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                
                <?php if (!empty($chart_images['trampasCapturaVoladores'])): ?>
                <div class="chart-container chart-break">
                    <h3 class="chart-title">TRAMPAS CON MAYOR CAPTURA - VOLADORES</h3>
                    <img src="<?= $chart_images['trampasCapturaVoladores'] ?>" alt="Trampas Mayor Captura Voladores" class="chart-image">
                    <?php if (!empty($notas_graficas['trampasCapturaVoladores'])): ?>
                    <div class="chart-notes">
                        <p><strong>OBSERVACIONES:</strong></p>
                        <p><?= nl2br(esc($notas_graficas['trampasCapturaVoladores'])) ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                
                <?php if (!empty($chart_images['trampasCapturaRastreros'])): ?>
                <div class="chart-container chart-break">
                    <h3 class="chart-title">TRAMPAS CON MAYOR CAPTURA - RASTREROS</h3>
                    <img src="<?= $chart_images['trampasCapturaRastreros'] ?>" alt="Trampas Mayor Captura Rastreros" class="chart-image">
                    <?php if (!empty($notas_graficas['trampasCapturaRastreros'])): ?>
                    <div class="chart-notes">
                        <p><strong>OBSERVACIONES:</strong></p>
                        <p><?= nl2br(esc($notas_graficas['trampasCapturaRastreros'])) ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                
                <?php if (!empty($chart_images['areasCapturaVoladores'])): ?>
                <div class="chart-container chart-break">
                    <h3 class="chart-title">AREAS QUE PRESENTARON CAPTURAS - VOLADORES</h3>
                    <img src="<?= $chart_images['areasCapturaVoladores'] ?>" alt="Areas Capturas Voladores" class="chart-image">
                    <?php if (!empty($notas_graficas['areasCapturaVoladores'])): ?>
                    <div class="chart-notes">
                        <p><strong>OBSERVACIONES:</strong></p>
                        <p><?= nl2br(esc($notas_graficas['areasCapturaVoladores'])) ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                
                <?php if (!empty($chart_images['areasCapturaRastreros'])): ?>
                <div class="chart-container chart-break">
                    <h3 class="chart-title">AREAS QUE PRESENTARON CAPTURAS - RASTREROS</h3>
                    <img src="<?= $chart_images['areasCapturaRastreros'] ?>" alt="Areas Capturas Rastreros" class="chart-image">
                    <?php if (!empty($notas_graficas['areasCapturaRastreros'])): ?>
                    <div class="chart-notes">
                        <p><strong>OBSERVACIONES:</strong></p>
                        <p><?= nl2br(esc($notas_graficas['areasCapturaRastreros'])) ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
