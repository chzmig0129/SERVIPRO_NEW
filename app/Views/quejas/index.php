            ...
            <form action="<?= site_url('quejas') ?>" method="get" class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select name="estado_queja" 
                        ...
                        <option value="En Proceso" <?= ($estado_queja_seleccionado == 'En Proceso') ? 'selected' : '' ?>>En Proceso</option>
                        <option value="Resuelta" <?= ($estado_queja_seleccionado == 'Resuelta') ? 'selected' : '' ?>>Resuelta</option>
                        <option value="Cerrada" <?= ($estado_queja_seleccionado == 'Cerrada') ? 'selected' : '' ?>>Cerrada</option>
                    </select>
                </div>
