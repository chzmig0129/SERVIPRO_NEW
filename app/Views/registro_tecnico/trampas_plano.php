...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.guardarNuevoId = function() {
        ...
        // Enviar el db_id del hidden field trampa_id (que contiene el PK)
        var dbIdValue = document.getElementById('trampa_id') ? document.getElementById('trampa_id').value : '';
        formData.append('db_id', dbIdValue);
